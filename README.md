...
![Portfolio Preview](https://github.com/rithish-s/Portfolio/blob/main/public/assets/projects-screenshots/portfolio/landing.png?raw=true)
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/rithish-s/Portfolio.git
    ```
