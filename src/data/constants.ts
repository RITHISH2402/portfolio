...
export const EXPERIENCE: Experience[] = [

  {
    ...
    company: "Self Learning & CTFs",
    description: [
      "Learning ethical hacking, penetration testing and network security.",
      "Practicing on platforms like TryHackMe and HackTheBox.",
      "Exploring Linux, Kali tools like Nmap, Wireshark, Metasploit and Burp Suite.",
    ],
    skills: [
      SkillNames.LINUX,
    ],
